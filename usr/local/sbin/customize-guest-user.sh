...
gsettings set org.gnome.desktop.background picture-uri-dark "file://$backgroundImage"
gsettings set org.gnome.desktop.background picture-options 'scaled'
# Bug (vermutl. in Mutter) unter Ubuntu 22.04: Farbe wird bei BG-Image nicht angezeigt.
...
gsettings set org.gnome.shell favorite-apps "['org.gnome.Nautilus.desktop', 'firefox_firefox.desktop', 'libreoffice-writer.desktop', 'libreoffice-calc.desktop', 'libreoffice-impress.desktop', 'vlc.desktop', 'yelp.desktop']"
